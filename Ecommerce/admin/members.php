...
if(isset($_SESSION['Username'])){
                        ...
                        echo "<tr>";
                           echo "<td>" . $row['UserID'] . "</td>";
                            echo "<td>";
                              if(empty($row['avatar'])){
                                  // echo 'No Image';
                              echo "<img src='uploads/avatars/default-avatar.png' alt='' >"; 
     ...
     <?php } elseif($do == 'Add'){  // Add Members Page ?>
         ...
         <form class="form-horizontal" action="?do=Insert" method="POST" enctype="multipart/form-data">
          <!--
           Par defaut : enctype="application/x-www-form-urlencoded"
          -->
      ...
      <?php 
          ...
          if($_SERVER['REQUEST_METHOD'] == 'POST'){
              ...
              $EndExt = end($ext);
              $avatarExtension = strtolower($EndExt);
                ...
                if(! empty($avatarName) && ! in_array($avatarExtension, $avatarAllowedExtension)){
                 ...
                 if($avatarSize > 4194304){ // 4 Mb

                     $formErrors[] = 'Avatar Cant Be Than <strong>4 MB</strong>';
                 }
